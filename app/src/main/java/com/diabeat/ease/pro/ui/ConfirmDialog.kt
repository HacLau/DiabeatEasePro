...
import com.diabeat.ease.pro.databinding.LayoutDialogConfirmBinding
...
class ConfirmDialog(
    ...
    lateinit var binding: LayoutDialogConfirmBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = LayoutDialogConfirmBinding.inflate(LayoutInflater.from(context))
